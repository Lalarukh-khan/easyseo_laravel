...
return [
    ...
    */
    ...
    'word_ended' => 'You have reached your words limit. please <a href="'.route('web.pricing').'" class="text-danger" style="text-decoration:underline;">upgrade here</a> to a higher plan or purchase additional words',
