...
<link rel="stylesheet" type="text/css" href="{{ asset('admin') }}/assets/plugins/quill/quill.core.css">
<link rel="stylesheet" type="text/css" href="{{ asset('admin') }}/assets/plugins/quill/quill.snow.css">
<style>
    .ck-editor__editable {
...
<script src="{{ asset('admin') }}/assets/plugins/quill/quill_new.min.js"></script>
