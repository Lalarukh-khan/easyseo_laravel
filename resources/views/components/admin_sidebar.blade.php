    ...
    <div class="app-brand demo">
        <a href="{{ route('admin.home') }}" class="app-brand-link">
            <span class="app-brand-logo demo">
                <svg class="logo-icon-2" id="logo-38" width="78" height="32" viewBox="0 0 78 32" fill="none"
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">easyseo.<span
                    style="color: #f47300;">ai</span></span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{route('admin.template.category.sorting')}}" class="menu-link">
                        <div data-i18n="Sorting">Sorting</div>
                    </a>
                </li>
                <li class="menu-item">
