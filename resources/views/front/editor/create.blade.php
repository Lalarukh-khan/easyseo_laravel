...
<div class="container">
    <div class="row">
		<div class="col-xl-8 col-lg-8 col-8">
			...
			<br>
			<div class="card radius-15" style="min-height: 450px;">
				<div class="card-body">
...
<script>
    ...
    function chatStripe(isAi, value, uniqueId) {
        return (
            `<p class="edtrval" id=${uniqueId}>${value}</p>`
        )
    }
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(apiUrl, {
            ...
            body: JSON.stringify({
                _token: token,
                prompt: 'write long paragraph in double qoutes and write 9 questions and 21 semantic keywords in ordered list without double qoutes about ' + data.get('prompt'),
