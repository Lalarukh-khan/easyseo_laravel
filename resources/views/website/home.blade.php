        ...
        <div class="row align-items-center homemobbackrobo">
            ...
            <div class="col-md-7 col-lg-7 col-sm-12 col-12 order-lg-1 order-md-1 order-sm-2 order-2 rbtinfos">
                <div class="banner-text">
                    <h3 class="col-white"  id="mainwht"> Texts that get the <span class="col-orange bnr-fnt"> results.</span> Say goodbye to manual SEO <span class="col-orange bnr-fnt">with the help of AI </span>
                        <!-- <span class="col-orange"> with AI. </span> -->
                    </h3>
                     <ul class="custom-list1">
                        <li id="main1wht"> <img alt="tick icon" src="{{asset('front')}}/images/check-icon2.svg"> Free Register </li>
                        <li id="main2wht"> <img alt="tick icon" src="{{asset('front')}}/images/check-icon2.svg"> Great Service </li>
                    </ul>
                    ...
                    <p id="main3wht"> EasySeo is an AI writing tool that helps you create unique seo optimized content for your E-commerce business, blog, ads, emails, and website without wasting time and effort! </p>
          ...
          <div class="row">
              <div class="col-md-4 col-lg-4 col-sm-4 col-12 m-b-50 p-l-25 p-r-25">
                <div class="contact-box contact-box2" id="cntctbxswht1">
                    ...
                    <p class="col-white" id="cntctbxswht1b"> Your AI sidekick is trained to produce high-converting marketing copy </p>
                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4 col-12 m-b-50 p-l-25 p-r-25" >
                <div class="contact-box contact-box2" id="cntctbxswht2">
                    ...
                    <p class="col-white" id="cntctbxswht2b"> Breakthrough writer’s block with Jasper who will help you spark fresh ideas. </p>
                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4 col-12 m-b-50 p-l-25 p-r-25">
                <div class="contact-box contact-box2" id="cntctbxswht3">
                    ...
                    <p class="col-white" id="cntctbxswht3b"> Whether you’re writing emails, captions, or love letters, Jasper will help craft the perfect
                        message. </p>
                </div>
            </div>
          </div>
...
<section class="trst">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 col-lg-6 col-sm-12 col-12">
                <div class="block-element mob-text-center tab-text-center">
                    <h3 class="title-text1" id="trsted"> Trusted By <br class="dn"> Over <span class="col-orange bnr-fnt"> 100+ Startups </span>
        ...
        <div class="row"  style="width: 100%; height: auto;">
            ...
            <div class="col-md-11 col-lg-11 col-sm-12 col-12 nwwbrbtbrdr">
                <div class="row" style="width: 100%; height: auto;">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-6">
                        <img alt="Icon" class="img-fluid playrbt m-t-180" src="{{asset('front')}}/images/play.svg">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="block-element text-center m-b-50 mobtextleft">
            <h3 class="title-text1" id="amzngwht2"> What <span class="col-orange bnr-fnt">amazing </span> content will <br class="dn"> you create with <span class="col-orange bnr-fnt">easyseo.ai?</span></h3>
        </div>
        <div class="block-element">
            <div class="row">
                <div class="col-md-3 col-lg-3 col-sm-6 col-6 p-l-20 p-r-20">
                    <div class="feature-box" id="amzngwht3">
                        <img alt="Icon" class="img-fluid ftr" id="hmamazonimg3" src="{{asset('front')}}/images/fontisto_amazon.svg">
                        <img alt="Icon" class="img-fluid ftr" id="hmamazonimg4" style="display: none;" src="{{asset('front')}}/images/fontisto_amazon2.png">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-6 p-l-20 p-r-20">
                    <div class="feature-box" id="amzngwht6">
                        ...
                        <h4 class="col-white" id="amzngwht6a"> Creative articles <br class="nomob"/> for websites  </h4>
...
<h1 class="advntg mobtextleft" id="atmtwht1">What is your <span class="col-orange bnr-fnt">advantages</span> to use content <br class="dn">
...
<div class="container anlss">
    <div class="row" style="width: 100%; height: auto;">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 bd-sec2">
            <div class="amnt row">
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon9.svg" id="atmtwhtimg1">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon9wht.png" id="atmtwhtimg2" style="display: none;">
                </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwht9">More accurate <br> analysis:</p>
                    <p class="anlsslrg" id="atmtwht2">Analyze large amounts of data quickly and accurately, <br> providing more detailed insights into your website's performance. </p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="amnt row">
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon10.svg" id="atmtwhtimg3">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon10wht.png" id="atmtwhtimg4" style="display: none;">
                </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwht3">Time-saving:</p>
                    <p class="anlsslrg" id="atmtwht4">You can automate many of the repetitive <br class="dn">  tasks that would otherwise take up a lot of <br class="dn">  your time, such as keyword research, <br class="dn">  and content optimization. </p>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top:60px; width: 100%; height: auto;">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="row p-l-50 amnts">
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon11.svg" id="atmtwhtimg5">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon11wht.png" id="atmtwhtimg6" style="display: none;">
                </div>
                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwht5">Better keyword suggestions: </p>
                    <p class="anlsslrg" id="atmtwht6">AI-powered SEO tools can use natural <br> language processing to suggest <br>  relevant keywords and topics that are <br>  more likely to drive traffic to your website. </p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="row p-l-60 amnts">
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon12.svg" id="atmtwhtimg7" >
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon12wht.png" id="atmtwhtimg8" style="display: none;">
                </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwht7">Better ROI</p>
                    <p class="anlsslrg" id="atmtwht8">Automate the content creation process <br> to save time and resources. <br> This improved efficiency leads to increased <br> productivity and, ultimately, a higher ROI for <br> the company. </p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-7 col-lg-7 col-sm-12 col-12 order-lg-2 order-md-2 order-sm-2 order-2">
                <div class="detail-text">
                    <h3 class="col-white mobtextleft" id="instwht1"> Turn your
                        <span class="col-orange bnr-fnt"> keywords </span>  into success <br class="dn">  with the help of
                        <span class="col-orange bnr-fnt"> EasySEO Ai! <br display="dn"> Actionable insights </span>
                        with AI now!
                    </h3>
                    <p class="col-white"id="instwht2"> We have the resources to assist you in taking <br> your content to the next level! </p>
    ...
    <div class="row"  style="width: 100%; height: auto;">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="row amntss" >
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon5.svg" id="atmtwhttimg1">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/icon5wht.png" id="atmtwhttimg2" style="display: none;">
                </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwhtt1">Enhanced user <br> experience:</p>
                    <p class="anlsslrg" id="atmtwhtt1a">Businesses can create customized information for their target audience. This <br class="dn"> improves the user experience by delivering <br class="dn"> content that is specific to their needs <br class="dn"> and interests. </p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="row amntss" >
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon1.svg" id="atmtwhttimg3">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/icon1wht.png" id="atmtwhttimg4" style="display: none;">
                </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwhtt2">Competitive <br> advantage:</p>
                    <p class="anlsslrg" id="atmtwhtt2a">You can stay ahead of your <br class="dn"> competitors by using AI-powered SEO <br class="dn"> tools to identify new opportunities to <br class="dn"> improve your website's search engine ranking. </p>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top:60px; width: 100%; height: auto;">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="row p-l-50 dn" >
                <div class="col-lg-1 col-md-1 col-sm-12 col-12"></div>
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/Icon6.svg"id="atmtwhttimg5" >
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/icon6wht.png" id="atmtwhttimg6" style="display: none;">
                </div>
                <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwhtt3">Improved <br> content <br> optimization: </p>
                    <p class="anlsslrg" id="atmtwhtt3a">Save writers time while also <br> ensuring that the content covers <br> all of the important points about <br> the topic. EasySEO can suggest <br> related topics or subtopics to include
                    <br> in the content to improve SEO. </p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="row p-l-60 dn" >
                <div class="col-lg-3 col-md-3 col-sm-4 col-4">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/icon3.svg" id="atmtwhttimg7">
                    <img alt="Icon" class="anlssimg1" src="{{asset('front')}}/images/icon3wht.png" id="atmtwhttimg8" style="display: none;">
                </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-8">
                    <p class="anlssaccrt anls" id="atmtwhtt4">Chat by <br> Easyseo.ai: </p>
                    <p class="anlsslrg" id="atmtwhtt4a">Chat feature allows you to <br> expand your goals by providing <br> a seamless connection to AI, <br> enabling you to conduct research, <br> generate content, and accomplish <br> your objectives in the most organic <br> way possible. </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row dn">
                ...
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_salesforce.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_notion-icon.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" id="hmamazonimg1" src="{{asset('front')}}/images/fontisto_amazon.svg">
                    <img alt="Icon" class="anlssimg2" id="hmamazonimg2" src="{{asset('front')}}/images/fontisto_amazon2.png" style="display: none;">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_shopify.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_facebook.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_google-gmail.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/Vector.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/skill-icons_wordpress.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_google-drive.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12">
                    <img alt="Icon" class="anlssimg2" src="{{asset('front')}}/images/logos_youtube-icon.svg">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-12"></div>
            </div>
        </div>
    ...
    <div>
        <div class="row wbst"  style="width: 100%; height: auto;">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                <h1 class="advntg pad-top-20" id="nowht">Now <span class="col-orange bnr-fnt">easyseo.ai</span> writes content for you, <br class="dn">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-12"></div>
            <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                <p class="bsns"id="nowht1">EasySeo is an AI writing tool that helps you create unique seo <br class="dn"> optimized content for your E-commerce business, blog, ads, emails, <br class="dn"> and website without wasting time and effort!</p>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 col-12"></div>
                <div class="col-lg-5 col-md-4 col-sm-1 col-1"></div>
                <div class="col-lg-2 col-md-4 col-sm-10 col-10">
                    <a href="{{route('register')}}" class="custom-btn4 cstmbtn4 mr-3 gt-strt" style="width: 100% !important; text-align: center;"> Get
                            Start </a>            </div>
                <div class="col-lg-5 col-md-4 col-sm-1 col-1"></div>
    ...
    <section class="pad-top-60 prpsl dn">
             <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-12 col-12"></div>
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <h1 class="advntg pad-bot-20" id="prpsl">For what <span class="col-orange bnr-fnt">proposals </span> could be <br class="dn">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-4 col-12 m-b-50 p-r-25 p-l-25">
                        <div class="contact-box contact-box2 nwwbcontact-box nwwbcontact-box2" id="prpsl1m">
                            <img class="cpyimg" alt="Icon" src="{{asset('front')}}/images/ic_twotone-content-paste.svg" id="prpslimg1">
                            <img class="cpyimg" alt="Icon" src="{{asset('front')}}/images/ic_twotone-content-pastewht.png" id="prpslimg2" style="display: none;">
                            <h2 class="col-white cntntm"id="prpsl2"> Content Marketing </h2>
                            <p class="cpy col-white" id="prpsl3"> Excellent for copywriters, content <br> and social media marketers </p>
                            <p class="pad-bot-20 col-grey nwwbcpy" id="prpsl4">With just a few clicks, you can produce on-brand content for any audience on various  platforms, including social media, landing pages, blogs, website content, emails, and more.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-4 col-12 m-b-50 p-r-25 p-l-25">
                        <div class="contact-box contact-box2 nwwbcontact-box2"id="prpsl2m">
                            <img class="cpyimg" alt="Icon" src="{{asset('front')}}/images/nimbus_marketing.svg" id="prpslimg3">
                            <img class="cpyimg" alt="Icon" src="{{asset('front')}}/images/nimbus_marketingwht.png" id="prpslimg4" style="display: none;">
                            <h2 class="col-white cntntm"id="prpsl5"> Performance Marketing </h2>
                            <p class="cpy col-white"id="prpsl6"> Excellent for PPC, growth, and <br> acquisition managers </p>
                            <p class="pad-bot-20 col-grey nwwbcpy" id="prpsl7">Create ad copy for Google, <br> Facebook, and other media to <br> help you Grow conversions, <br> CTRs, and lower your CPC. Using  our high-quality tools, your <br>  brand will get fast and effective <br> results.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-4 col-12 m-b-50 p-r-25 p-l-25">
                        <div class="contact-box contact-box2 nwwbcontact-box nwwbcontact-box2"id="prpsl3m">
                            <img class="cpyimg" alt="Icon" src="{{asset('front')}}/images/icon-park-outline_seo.svg"id="prpslimg5">
                            <img class="cpyimg" alt="Icon" src="{{asset('front')}}/images/icon-park-outline_seowht.png"id="prpslimg6" style="display: none;">
                            <h2 class="col-white cntntm"id="prpsl8"> SEO optimization </h2>
                            <p class="cpy col-white" id="prpsl9"> Excellent for SEO agencies,<br> freelance seo specialists </p>
                            <p class="pad-bot-20 col-grey nwwbcpy" id="prpsl10">Our tool is the secret weapon you've been looking for to take your SEO game to the next level. Create keyword-rich SEO articles and meta descriptions to help you rank at the top of Google searches.</p>
                        </div>
                    </div>
                </div>
       ...
       <section class="bsnsadvntg pad-top-40">
           <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12 col-12"></div>
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        <h1 class="advntg pad-bot-40" id="bsnsadvntg"><b>Who will be exited about  <span class="col-orange bnr-fnt">easyseo.ai</span>?</b></h1>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-12 col-12"></div>
            </div>
            <div class="row">
                    ...
                    <div class="row m-t-100">
                        <div class="col-lg-12 p-l-20 p-r-20">
                            <div class="row bsnsonr nwwbcontact-box2"id="bsnsadvntg1">
                                <div class="col-lg-5">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man1.svg"id="bsnsadvntgimg1">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man1.png"id="bsnsadvntgimg2" style="display: none;">
                                </div>
                                <div class="col-lg-7 ensr nwwbensr">
                                    <h2 class="col-white nwwbmrktnmngr"id="bsnsadvntg1a"><b> Small business <br> owners </b></h2>
                                    <p class="atrct"id="bsnsadvntg1b">Small business owners, who are looking to improve their online visibility and increase traffic to their website. Entrepreneurs who are just starting out and want to ensure that their website is optimized for search engines to attract customers.</p>
                                    <a class= "hdrbtn" href="{{route('login')}}"id="bsnsadvntg1c"> Read more > </a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row bsnsonr nwwbcontact-box2"id="bsnsadvntg2">
                                <div class="col-lg-5">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man3.svg"id="bsnsadvntgimg3">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man3.png"id="bsnsadvntgimg4" style="display: none;">
                                </div>
                                <div class="col-lg-7">
                                    <h2 class="col-white nwwbmrktnmngr"id="bsnsadvntg1d"><b> Bloggers & <br> Influencers </b></h2>
                                    <p class="atrct"id="bsnsadvntg1e">Bloggers who need to optimize their content for search engines but lack the time or expertise to do so manually. Content creators who want to ensure that their video
                                    or audio content is discoverable by search engines.</p>
                                    <a class= "hdrbtn" href="{{route('login')}}"id="bsnsadvntg1f"> Read more > </a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="row">
                        ...
                        <div class="row bsnsonr nwwbcontact-box2"id="bsnsadvntg3">
                                <div class="col-lg-5">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man2.svg"id="bsnsadvntgimg5">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man2.png"id="bsnsadvntgimg6" style="display: none;">
                                </div>
                                <div class="col-lg-7">
                                    <h2 class="col-white nwwbmrktnmngr"id="bsnsadvntg1g"><b> Marketing managers </b></h2>
                                    <p class="atrct"id="bsnsadvntg1h">Marketing managers who want to streamline their SEO efforts and generate high-quality content at scale. Social media managers who want to ensure that the content they share on social media is optimized for search engines.</p>
                                    <a class= "hdrbtn" href="{{route('login')}}"id="bsnsadvntg1i"> Read more > </a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row bsnsonr nwwbcontact-box2"id="bsnsadvntg4">
                                <div class="col-lg-5">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man4.svg" id="bsnsadvntgimg7" >
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man4.png"id="bsnsadvntgimg8" style="display: none;">
                                </div>
                                <div class="col-lg-7">
                                    <h2 class="col-white nwwbmrktnmngr"id="bsnsadvntg1j"><b> SEO specialists </b></h2>
                                    <p class="atrct"id="bsnsadvntg1k">SEO specialists are responsible for optimizing websites for search engines. They could use an AI-powered SEO tool to automate certain tasks and improve the efficiency of their work.</p>
                                    <a class= "hdrbtn" href="{{route('login')}}"id="bsnsadvntg1l"> Read more > </a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row bsnsonr nwwbcontact-box2"id="bsnsadvntg5">
                                <div class="col-lg-5">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man5.svg"id="bsnsadvntgimg9">
                                    <img class="mnimg" alt="Icon" src="{{asset('front')}}/images/man5.png"id="bsnsadvntgimg10" style="display: none;">
                                </div>
                                <div class="col-lg-7">
                                    <h2 class="col-white nwwbmrktnmngr"id="bsnsadvntg1m"><b> Digital <br> marketing <br> agencies</b></h2>
                                    <p class="atrct"id="bsnsadvntg1n">Digital marketing agencies that need to produce SEO-friendly content for their clients on a regular basis. E-commerce website owners who want to optimize their product pages and improve their conversion rates.</p>
                                    <a class= "hdrbtn" href="{{route('login')}}"id="bsnsadvntg1o"> Read more > </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="pad-top-40 pad-bot-20 bxs">
    <div class="container">
        <div class="block-element text-center m-b-10">
            <h3 class="title-text1" id="bxswht"> What Our <span class="col-orange bnr-fnt"> Happy User </span> Says: </h3>
        </div>
        <div class="block-element">
            <div class="custom-slider1 no-arrows dots-1">
                <div class="testimonial-box">
                    <div id="bxswht1">
                        <h6>
                            <img alt="Star Icon" src="{{asset('front')}}/images/star-icon.svg">
                            <img alt="Star Icon" src="{{asset('front')}}/images/star-icon.svg">
                            <img alt="Star Icon" src="{{asset('front')}}/images/star-icon.svg">
                            <img alt="Star Icon" src="{{asset('front')}}/images/star-icon.svg">
                            <img alt="Star Icon" src="{{asset('front')}}/images/star-icon.svg">
                        </h6>
                        <p class="col-white" id="bxswht1a"> EasySEO is a game changer! It has revolutionized the way we create content, and has saved us so much time and effort. Highly recommended! </p>
                        <h4 id="bxswht1b">
                ...
                <div class="testimonial-box">
                    <div id="bxswht2">
                        ...
                        <p class="col-white" id="bxswht2a"> As a busy marketer, EasySEO has been a godsend. It's incredibly user-friendly and produces high-quality content with ease. I can't imagine going back to the old ways.</p>
                        <h4 id="bxswht2b">
                ...
                <div class="testimonial-box">
                    <div id="bxswht3">
                        ...
                        <p class="col-white" id="bxswht3a"> EasySEO is the future of content creation. It's efficient, effective, and allows us to focus on the bigger picture of our marketing strategy. Our team is loving it! </p>
                        <h4 id="bxswht3b">
                ...
                <div class="testimonial-box">
                    <div id="bxswht4">
                        ...
                        <p class="col-white" id="bxswht4a"> EasySEO is a game changer! It has revolutionized the way we create content, and has saved us so much time and effort. Highly recommended! </p>
                        <h4 id="bxswht4b">
                            <img src="{{asset('front')}}/images/avatar-1.png">
                            Andrew Kozic 4
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-7 col-sm-12 col-12 order-lg-1 order-md-1 order-sm-2 order-2">
                <div class="detail-text">
                    ...
                    <p class="col-white" id="getwht1">Easily bring AI in your workflow to improve & create SEO content, wherever you are. </p>
                    <a href="{{route('register')}}" class="custom-btn4 nwwbhmgtstrt"> Get Start </a>
                </div>
            </div>
            <!-- Detail Textual Column Ends Here -->
    ...
    <section class="pad-top-40 acrdion nwwbpdngtp">
        <div class="container">
            <div class="block-element text-center m-b-50">
                <h3 class="title-text1" id="gotwht"> Got questions <span class="col-orange bnr-fnt"> about easy.ai</span>? <br class="dn"> We've got
                    answers. </h3>
            </div>
            <div class="block-element">
                <div id="accordion" class="myaccordion">
                    <div class="card accordion-block">
                        <button class="d-flex align-items-center justify-content-between btn btn-link collapsed"
                            ...
                            aria-controls="collapseTwo" id="gotwht2">
                            <span id="gotwht2a">What exactly is EasySEO?</span>
                            <span class="faq-icons">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/plus-icon.png" id="gotwht2e">
                                <img alt="Minus" class="minus-icon" src="{{asset('front')}}/images/minus-icon.png" id="gotwht2f">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/blkplus.png" id="gotwht2c" style="display: none;">
                            </span>
                        </button>
                    ...
                    <div class="card accordion-block">
                        <button class="d-flex align-items-center justify-content-between btn btn-link"
                            ...
                            aria-controls="collapseOne" id="gotwht1">
                            <span  id="gotwht1a">The AI output: is it unique?</span>
                            <span class="faq-icons">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/plus-icon.png" id="gotwht1e">
                                <img alt="Minus" class="minus-icon" src="{{asset('front')}}/images/minus-icon.png" id="gotwht1f">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/blkplus.png" id="gotwht1c" style="display: none;">
                            </span>
                        </button>
                    ...
                    <div class="card accordion-block">
                        <button class="d-flex align-items-center justify-content-between btn btn-link collapsed"
                            ...
                            aria-controls="collapseThree" id="gotwht3" id="gotwht3a">
                            <span id="gotwht3a">When will I be able to access EasySEO?</span>
                            <span class="faq-icons">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/plus-icon.png" id="gotwht3e">
                                <img alt="Minus" class="minus-icon" src="{{asset('front')}}/images/minus-icon.png" id="gotwht3f">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/blkplus.png" id="gotwht3c" style="display: none;">
                            </span>
                        </button>
                    ...
                    <div class="card accordion-block">
                        <button class="d-flex align-items-center justify-content-between btn btn-link collapsed"
                            ...
                            aria-controls="collapseTwo" id="gotwht4">
                            <span id="gotwht4a">How does EasySEO help e-commerce teams save time <br> and money?</span>
                            <span class="faq-icons">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/plus-icon.png" id="gotwht4e">
                                <img alt="Minus" class="minus-icon" src="{{asset('front')}}/images/minus-icon.png" id="gotwht4f">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/blkplus.png" id="gotwht4c" style="display: none;">
                            </span>
                        </button>
                    ...
                    <div class="card accordion-block">
                        <button class="d-flex align-items-center justify-content-between btn btn-link collapsed"
                            ...
                            aria-controls="collapseThree" id="gotwht5">
                            <span id="gotwht5a">Who can benefit from EasySEO?</span>
                            <span class="faq-icons">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/plus-icon.png" id="gotwht5e">
                                <img alt="Minus" class="minus-icon" src="{{asset('front')}}/images/minus-icon.png" id="gotwht5f">
                                <img alt="Plus" class="plus-icon" src="{{asset('front')}}/images/blkplus.png" id="gotwht5c" style="display: none;">
                            </span>
                        </button>
        ...
        <div class="row m-b-20">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="row col-lg-12 pad-bot-30">
                    ...
                    <div class="block-element text-center m-b-10">
                        <p class="tac col-white font-size-30" id="menuitemwht"><b>Save up to 20% with yearly billing </b></p>
                    </div>
                </div>
            </div>
        <div class="block-element">
                    ...
                    <h2 class="col-white col-lg-12 cntntm pad-bot-30"  id="prcngwht1a"> Basic </h2>
                        <div class="pricing-box-head">
                            ...
                            <div class="pricing-title">
                                <h5 class="col-white d-f j-c-e" id="prcngwht1b"><b> 7 Days <br> free trial </b></h5>
                        ...
                        <div class="pricing-detail">
                            ...
                            <ul>
                                ...
                                <li class="pad-bot-40" id="cpywht2a"> <img src="{{asset('front')}}/images/tickorange.svg"> Ezchat </li>
                            </ul>
                        </div>
                        <div class="pricing-btn">
                            <a href="javascript:void(0);" class="custom-btn2" id="prcngwht1f"> <u> View All Details</u> </a>
                            @if (auth('web')->check())
                    ...
                    <h2 class="col-white col-lg-12 cntntm pad-bot-20" id="prcngwht21achk"> Premium </h2>
                            ...
                            <div>
                                <div class="demo">
                                    <div class="range-slider">
                                        <input type="range" id="solo_proplan" value="@if($words == '20000' || $words < '20000'){{ 0 }}@elseif ($words == '50000'){{ 1 }}@elseif ($words == '200000'){{ 2 }}@elseif ($words == '500000'){{ 3 }}@endif" min="0" steps="1" max="3">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pricing-detail">
                            ...
                            <ul>
                                ...
                                <li id="prcngwht29"> <img src="{{asset('front')}}/images/tickpurple.svg"> Keyword Generati </li>
                        ...
                        <div class="pricing-btn">
                            ...
                            @if (auth('web')->check())
                                ...
                                class="custom-btn3" onclick="showCheckout(event);" id="buy-plan" data-current="{{ $words }}"> Upgrade </a>
                    ...
                    <h2 class="col-white col-lg-12 cntntm" id="prcngwht3a"> Enterprise </h2>
                        ...
                        <div class="pricing-detail">
                            ...
                            <ul>
                                ...
                                <li id="cpywht2b"> <img src="{{asset('front')}}/images/tickorange.svg"> Ezchat </li>
                                <li id="cpywht1a"> <img src="{{asset('front')}}/images/tickorange.svg"> 25+ languages </li>
                                <li id="cpywht1b"> <img src="{{asset('front')}}/images/tickorange.svg"> Live chat support </li>
                            </ul>
                        </div>
                        <div class="pricing-btn">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-lg-8 col-sm-6 col-12">
                <p class="tls col-white pad-bot-30 font-size-40" id="writewht1a"><b>Our latest <span class="col-orange font-size-40">blog</span>  topics: </b></p>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-6 col-12">
                <a class="col-white font-size-15 m-t-20 tae d-f j-c-e dn" id="writewht1b" href="{{route('web.blog.all')}}"><u>See all topics</u></a>
            </div>
        </div>
        <div class="block-element">
            <div class="row" style="display: none !important;">
                <div class="col-md-4 col-lg-4 col-sm-6 col-12 p-l-25 p-r-25 tls dn">
                    <div class="feature-boxes nwwbfeature-boxes" id="writewht1">
                        <img class="pad-bot-20" alt="Icon" src="{{asset('front')}}/images/Imge6.svg">
                        <p class="col-white pad-bot-20 p-l-20 p-r-20" id="writewht2a"><span class="blkchn">Engineering</span>&nbsp; &nbsp; &nbsp; 5 min read</p>
                        <h4 class="col-white p-l-20 p-r-20 font-size-20" id="writewht2b">What is a Decentralized Autonomous Organization ? </h4>
                        <p class="pad-bot-30 font-size-15 font-weight-lighter col-white p-l-20 p-r-20 col-grey" id="writewht3a">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros. </p>
                        <a class= "hdrbtn m-b-20 m-l-25" href="{{route('login')}}"id="writewht3b"> Read more > </a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-12 p-l-25 p-r-25 tls dn">
                    <div class="feature-boxes nwwbfeature-boxes" id="writewht2">
                        <img class="pad-bot-20" alt="Icon" src="{{asset('front')}}/images/Imge5.svg">
                        <p class="col-white pad-bot-20 p-l-20 p-r-20" id="writewht1c"><span class="blkchn">Blockchain </span>&nbsp; &nbsp; &nbsp; 5 min read</p>
                        <h4 class="col-white p-l-20 p-r-20 font-size-20"id="writewht2c">Guide to buy <br> cryptocurrency safely: <br> September 2022 </h4>
                        <p class="pad-bot-30 font-size-15 font-weight-lighter col-white p-l-20 p-r-20 col-grey"  id="prcngwht">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros. </p>
                        <a class= "hdrbtn m-b-20 m-l-25" href="{{route('login')}}"id="writewht3c"> Read more > </a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-12 p-l-25 p-r-25 tls">
                    <div class="feature-boxes nwwbfeature-boxes" id="writewht3">
                        <img class="pad-bot-20" alt="Icon" src="{{asset('front')}}/images/Imge7.svg">
                        <p class="col-white pad-bot-20 p-l-20 p-r-20"id="hm1"><span class="blkchn">Crypto</span>&nbsp; &nbsp; &nbsp; 5 min read</p>
                        <h4 class="col-white p-l-20 p-r-20 font-size-20" id="hm2">Crypto state of play : September 2022 </h4>
                        <p class="pad-bot-30 font-size-15 font-weight-lighter col-white p-l-20 p-r-20 col-grey" id="hm3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros. </p>
                        <a class= "hdrbtn m-b-20 m-l-25" href="{{route('login')}}"id="hm4"> Read more > </a>
                    </div>
                </div>
            </div>
            <div class="row">
                    @forelse ($blogs as $blog)
                        <div class="col-md-6 col-lg-4 col-sm-6 col-12 p-l-20 p-r-20 m-b-20 engn">
                            <div class="feature-boxes nwwbfeature-boxes ftr-bx">
                                ...
                                <p class="col-white pad-bot-20 p-l-20 p-r-20 blkchnpara" ><span class="blkchn">{{ $blog->category->name }} </span>&nbsp; &nbsp; &nbsp; 5 min read</p>
                                <h4 class="col-white p-l-20 p-r-20 font-size-20" > {{ $blog->title }} </h4>
                                <p class="pad-bot-15 font-size-15 font-weight-lighter col-white p-l-20 p-r-20 lrm">{{Str::limit($blog->description,150,$end='...')}} </p>
