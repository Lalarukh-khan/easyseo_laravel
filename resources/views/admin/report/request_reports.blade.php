...
@section('content')
<!--breadcrumb-->
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Report /</span> Request</h4> 
...
<div class="row">
    ...
    <div class="col-12 col-lg-3">
        <div class="card radius-15">
            <div class="card-body text-center">
                <div class="widgets-icons mx-auto bg-light-info text-warning rounded-circle"><i
                        class='fadeIn animated bx bx-up-arrow-alt'></i></i>
                </div>
                <h4 class="mb-0 font-weight-bold mt-3" id="chatbot_requests"></h4>
                <p class="mb-0">Chatbot Requests</p>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
            ...
            $('#zero-config').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.report.requests') }}",
                    data: {
                        'daterange': date,
                    }
                },
        ...
        function load_totals(date = ''){
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#chatbot_requests').html(res.chatbot)
                }
            });
        }
