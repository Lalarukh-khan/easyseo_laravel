...
@section('content')
<!--breadcrumb-->
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Template /</span> {{isset($edit) ? 'Edit' : 'Add'}}</h4>
                                ...
                                <div class="accordion-item  mb-2 mt-3" id="card_item_{{$row_count}}">
                                    <h2 class="accordion-header" id="heading{{$row_count}}">
                                        <button class="accordion-button field_name" type="button"
                                            ...
                                            Question {{$row_count}} [!text{{$row_count}}!]
                                        </button>
                                    </h2>
