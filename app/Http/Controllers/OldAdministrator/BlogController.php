        ...
        if(request()->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<a href="'.route('newadmin.blog.category.edit',$row->hashid).'" style="font-size:20px;"><i class="fadeIn animated bx bx-edit"></i></a> &nbsp;&nbsp;
                    <a href="javascript:void(0);" onclick="ajaxRequest(this)" data-url="'.route('newadmin.blog.category.delete',$row->hashid).'" style="font-size:20px;"><i class="fadeIn animated bx bx-trash" style=" color: red; "></i></a>';
                })
    ...
    public function all_blog()
    {
        ...
        if(request()->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<a href="'.route('web.blog.details',$row->hashid).'" target="_blank" style="font-size:20px;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-up-right text-info"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg></a> &nbsp;<a href="'.route('newadmin.blog.edit',$row->hashid).'" style="font-size:20px;"><i class="fadeIn animated bx bx-edit"></i></a> &nbsp;&nbsp;
                    <a href="javascript:void(0);" onclick="ajaxRequest(this)" data-url="'.route('newadmin.blog.delete',$row->hashid).'" style="font-size:20px;"><i class="fadeIn animated bx bx-trash" style=" color: red; "></i></a>';
                })
